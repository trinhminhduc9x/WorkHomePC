...
public interface ICustomerRepository extends JpaRepository<Customer, Integer> {
    ...
    @Query(value = " select *  from furama_minhduc_beautiful.customer where name like %:name% and email like %:email% and customer_type like %:CustomerTypeID%", nativeQuery = true)
